...
export const fetchBrandProducts = slug => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      let products = [
        {
          ...
          "slug": "pr-3",
          "imageUrl": "https://static-01.daraz.pk/p/62516dea0ee96e500413e883e433be35.jpg_720x720q80.jpg_.webp",
          "name":"Oxford Cotton Plain Polo T-Shirt For Men",
          "brand":{
            "name":"Polo",
            slug: "polo"
      ...
      dispatch({
        type: FETCH_PRODUCTS,
        payload: products.filter(item => item.brand?.slug === slug)
      });
    } catch (error) {
      handleError(error, dispatch);
    } finally {
...
// console.log(response, 'response of data.json');
let products = [
  {
    "slug": "pr-1",
    "imageUrl": "https://static-01.daraz.pk/p/86a8de5d319c0cb92f2d92ecf52541ba.jpg_720x720q80.jpg_.webp",
    ...
    "price": 3299
      ...
      dispatch({
        type: FETCH_PRODUCTS,
        payload: products.filter(item => item.category?.slug === slug)
      });
    } catch (error) {
      handleError(error, dispatch);
    } finally {
